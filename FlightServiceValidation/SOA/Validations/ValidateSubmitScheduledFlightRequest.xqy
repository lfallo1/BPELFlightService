...
declare variable $submitScheduledFlightRequest as element() external;

declare function local:validateSubmitScheduledFlight($submitScheduledFlightRequest as element() ) as element() (:: element(*, ns1:Validation) ::) {
    <ns1:Validation>
...
declare function local:validateSubmitScheduledFlightDateAndTimeConstraints($submitScheduledFlightRequest) {
    <ns1:ValidationErrorList>
      {
      if ( xs:date($submitScheduledFlightRequest/fse:TimePlanningUnit/ref:startDate) lt (fn:current-date() + xs:dayTimeDuration('P4D'))) then
      <ns1:ValidationError>
      <ns1:code>22</ns1:code>
